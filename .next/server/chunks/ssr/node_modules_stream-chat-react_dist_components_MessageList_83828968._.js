...
const insertIntro = (messages, headerPosition)=>{
    ...
    for(let i = 0; i < messages.length; i += 1){
        const message = messages[i];
        const messageTime = message.created_at && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$stream$2d$chat$2d$react$2f$dist$2f$i18n$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isDate"])(message.created_at) ? message.created_at.getTime() : null;
        const nextMessage = messages[i + 1];
        const nextMessageTime = nextMessage.created_at && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$stream$2d$chat$2d$react$2f$dist$2f$i18n$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isDate"])(nextMessage.created_at) ? nextMessage.created_at.getTime() : null;
        // header position is smaller than message time so comes after;
        if (messageTime && messageTime < headerPosition) {
            // if header position is also smaller than message time continue;
            if (nextMessageTime && nextMessageTime < headerPosition) {
                if (messages[i + 1] && messages[i + 1].customType === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$stream$2d$chat$2d$react$2f$dist$2f$constants$2f$messageTypes$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["CUSTOM_MESSAGE_TYPE"].date) continue;
                if (!nextMessageTime) {
...
const getGroupStyles = (message, previousMessage, nextMessage, noGroupByUser, maxTimeBetweenGroupedMessages)=>{
    if (message.customType === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$stream$2d$chat$2d$react$2f$dist$2f$constants$2f$messageTypes$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["CUSTOM_MESSAGE_TYPE"].date) return '';
    if (message.customType === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$stream$2d$chat$2d$react$2f$dist$2f$constants$2f$messageTypes$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["CUSTOM_MESSAGE_TYPE"].intro) return '';
    if (noGroupByUser || message.attachments?.length !== 0) return 'single';
    const isTopMessage = !previousMessage || previousMessage.customType === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$stream$2d$chat$2d$react$2f$dist$2f$constants$2f$messageTypes$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["CUSTOM_MESSAGE_TYPE"].intro || previousMessage.customType === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$stream$2d$chat$2d$react$2f$dist$2f$constants$2f$messageTypes$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["CUSTOM_MESSAGE_TYPE"].date || previousMessage.type === 'system' || previousMessage.type === 'error' || previousMessage.attachments?.length !== 0 || message.user?.id !== previousMessage.user?.id || previousMessage.deleted_at || message.reaction_groups && Object.keys(message.reaction_groups).length > 0 || (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$stream$2d$chat$2d$react$2f$dist$2f$components$2f$Message$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isMessageEdited"])(previousMessage) || maxTimeBetweenGroupedMessages !== undefined && previousMessage.created_at && message.created_at && new Date(message.created_at).getTime() - new Date(previousMessage.created_at).getTime() > maxTimeBetweenGroupedMessages;
    const isBottomMessage = !nextMessage || nextMessage.customType === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$stream$2d$chat$2d$react$2f$dist$2f$constants$2f$messageTypes$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["CUSTOM_MESSAGE_TYPE"].intro || nextMessage.customType === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$stream$2d$chat$2d$react$2f$dist$2f$constants$2f$messageTypes$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["CUSTOM_MESSAGE_TYPE"].date || nextMessage.type === 'system' || nextMessage.type === 'error' || nextMessage.attachments?.length !== 0 || message.user?.id !== nextMessage.user?.id || nextMessage.deleted_at || nextMessage.reaction_groups && Object.keys(nextMessage.reaction_groups).length > 0 || (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$stream$2d$chat$2d$react$2f$dist$2f$components$2f$Message$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isMessageEdited"])(message) || maxTimeBetweenGroupedMessages !== undefined && nextMessage.created_at && message.created_at && new Date(nextMessage.created_at).getTime() - new Date(message.created_at).getTime() > maxTimeBetweenGroupedMessages;
...
function isDateSeparatorMessage(message) {
    return message.customType === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$stream$2d$chat$2d$react$2f$dist$2f$constants$2f$messageTypes$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["CUSTOM_MESSAGE_TYPE"].date && !!message.date && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$stream$2d$chat$2d$react$2f$dist$2f$i18n$2f$utils$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isDate"])(message.date);
}
...
function defaultRenderMessages({ channelUnreadUiState, components, customClasses, lastReceivedMessageId: lastReceivedId, messageGroupStyles, messages, readData, sharedMessageProps: messageProps }) {
    ...
    for(let index = 0; index < messages.length; index++){
        ...
        } else if (message.customType === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$stream$2d$chat$2d$react$2f$dist$2f$constants$2f$messageTypes$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["CUSTOM_MESSAGE_TYPE"].intro && HeaderComponent) {
            renderedMessages.push(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].createElement("li", {
                key: 'intro'
...
const messageRenderer = (virtuosoIndex, _data, virtuosoContext)=>{
    ...
    if (!message) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].createElement("div", {
        style: {
            height: '1px'
        }
